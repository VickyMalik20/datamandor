...
export default function MenuBerasPolos() {
                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="modal-body">
                                ...
                                <div className="mb-3">
                                    <label className="form-label">Quantity (Bal)</label>
                                    <input
                                        type="number"
                                        name="quantity"
    ...
    const handleDelete = async (id) => {
        ...
        if (isConfirmed) {
            ...
            const { error } = await supabase
                .from('bs_5') // Ganti sesuai nama tabel Anda
                .delete()
                .eq('id', id);
    ...
    return (
        <div>
            <h1 className="text-center text-primary fw-bold fs-2 mt-2">Blambangan Sakti 5 KG</h1>
